export default function load() {
    ...
    <div class="fixed h-full w-full top-0 left-0 z-[100] bg-black opacity-30"></div>
    <div class=" fixed h-full w-full top-0 left-0 z-[200] cursor-wait flex gap-3 items-center justify-center">
      <div
