...
import { getItemLocal, getLocal, updateLocal } from "../components/localstorage.js";
    ...
    return `
      <div class="container px-5 pt-5 pb-10 mx-auto lg:w-4/5">
        ...
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            <div class="">
                <p class="mb-1 text-lg font-bold" sumTotal></p>
...
function rederItemCart(item){
    return `
        ...
        <img src="/static/upload/${item.thumb}" alt="product-image" class="w-full rounded-lg sm:w-[110px]" />
        <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            <div class="mt-5 sm:mt-0">
            <h2 class="text-lg font-bold text-gray-900">${item.name}</h2>
            <p class="mt-1 text-xs text-gray-700">${convertToVND(item.price)}</p>
            </div>
