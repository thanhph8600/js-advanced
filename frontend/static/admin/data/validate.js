export default class Validator {
  ...
  static valName(name) {
      var regex = /^[a-zA-ZĐạtàáâãảạăắẳằặẵâấẩầậẫêasdsadểềếệễẻẽẹèéêìíòóôỏọõồôốổộỗưứừửựữởơợớờợỡđùúýăđĩũơưÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚÝĂĐĨŨƠƯ]+(([',. -][a-zA-ZĐạtàáâãèéêìíòóôõùúýăđĩũơưÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚÝĂĐĨŨƠƯ ])?[a-zA-ZĐạtàáâãèéêìíòóôõùúýăđĩũơưÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚÝĂĐĨŨƠƯ]*)*$/;
